...
public:
        ...
        : it_(nh_)
    {
        ...
        // Subscribe to input video feed and publish output data
...
//         cout<<"CV_MAJOR_VERSION "<<CV_MAJOR_VERSION << endl; //specific parts of it
        ...
        overlayImage( &frame, &mask_frame_r, pt2 );
        ...
        threshold( FrameOut, FrameOut, 50, 255,1 );
        int Mo_size = 15;
