...
class idwrench():
    def __init__(self):
        ...
        if self.live:
            ...
            self.img = cv2.imread(self.dir+'/frame0000.jpg')
    ...
    def process_img(self,img):
        ...
        if False: #True: #self.preview_flag:
            print "binary"
            cv2.imshow('img',binary_dilate)
            cv2.waitKey(0)
            cv2.destroyAllWindows()
        img[:,0:600,:] = 0
        img[0:600,:] = 0
        ...
        row = int(round(params[wrench_ind,1]))
        col = int(round(params[wrench_ind,0]))
        ...
        # Create figure
        cv2.circle(self.img,(col,row), 20, (0,255,0), 2, cv2.CV_AA)
        lcol = 1370-20
        lrow = 120+20
        cv2.line(self.img,(1920/2+20,1080/2),(1920/2-20,1080/2),(255,0,0),5)
        cv2.line(self.img,(1920/2,1080/2-20),(1920/2,1080/2+20),(255,0,0),5)
